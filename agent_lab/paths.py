...
GITHUB_REPORTS_DIR = REPO_ROOT / "github_reports"
GITHUB_REPORTS_OUTPUT_DIR = GITHUB_REPORTS_DIR / "output"
HEALTH_RECORDS_DIR = REPO_ROOT / "health_records"
HEALTH_RECORDS_OUTPUT_DIR = HEALTH_RECORDS_DIR / "output"
